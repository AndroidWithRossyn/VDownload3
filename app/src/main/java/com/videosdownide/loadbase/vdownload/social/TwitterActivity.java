...
import static com.videosdownide.loadbase.vdownload.utils.Utils.RootDirectoryTwitter;
...
public class TwitterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imAppIcon.setImageDrawable(getResources().getDrawable(R.drawable.social_twitter));
