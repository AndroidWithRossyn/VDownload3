...
import com.videosdownide.loadbase.vdownload.splash_anim.OnBoardingFragment;
import com.videosdownide.loadbase.vdownload.splash_anim.OnBoardingFragment2;
import com.videosdownide.loadbase.vdownload.splash_anim.OnBoardingFragment3;
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (isFirstTime) {
                    ...
                    Intent intent = new Intent(FirstLoadingPageActivity.this,DashboardActivity.class);
